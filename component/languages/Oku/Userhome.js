...
import ToAwing from './learn/ToAwing';
import Punctuation from './learn/Punctuation';
import PunctuationEx from './exercises/Punctuation';
import Nouns from './learn/Nouns';
import NounsExercise from './exercises/Nouns';
import Verbs from './learn/Orthography';
import VerbsEx from './exercises/Verbs';
import exercises from './exercises/exercises';
import Alphabet from './exercises/Alphabet';
import Salutation from './learn/Division';
import SalutationEx from './exercises/Division';
import contact from './contact/contact';
import profile from './profile/profile';
import loading from '../../loading'
import loading2 from '../../loading2'
import splashAwing from './splashAwing'
...
function stackedTabLearn(){
  ...
  <Stack.Screen name="ToAwing" component={ToAwing} options={{ headerShown: false }}/>
