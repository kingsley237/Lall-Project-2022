  ...
  showBubbles={false}>
        ...
        <Text style={styles.head}>The tones</Text>
              ...
              <View style={styles.title2}>
                ...
                <Text style={styles.top2}>[ǎ]</Text>
                <Text style={styles.top2}>ǎ</Text>
              </View>
              <View style={styles.title2}>
                <Text style={styles.top2}>Low-High-Low</Text>
                <Text style={styles.top2}>[ǎ̀]</Text>
                <Text style={styles.top2}>ǎ</Text>
              </View>
              <View style={styles.title2}>
                <Text style={styles.top2}>High-Low</Text>
                <Text style={styles.top2}>[â]</Text>
                <Text style={styles.top2}>â</Text>
              </View>
              <View style={styles.title2}>
                <Text style={styles.top2}>High-Mid</Text>
                <Text style={styles.top2}>[á̄]</Text>
                <Text style={styles.top2}>â</Text>
              </View>
              <View style={styles.move}>
              <Blink>
        ...
        <View style={styles.container}>
          <View style={styles.content}>
            <Text style={styles.letter}>{data.alpha[0].ɣ[0].letter}</Text>
            <Text style={styles.sound}>sound: <Text style={styles.bold}>/{data.alpha[0].ɣ[0].sound}/</Text></Text>
            <View style={styles.col}>
              <Text style={styles.example}>Example:   <Text style={styles.bold}>{data.alpha[0].ɣ[0].ex}</Text></Text>
              <Text style={styles.meaning}>Meaning:   <Text style={styles.bold}>{data.alpha[0].ɣ[0].meaning}</Text></Text>
            </View>
          </View>
          <TouchableOpacity style={styles.mic} onPress={()=> Speak(data.alpha[0].ɣ[0].letter, data.alpha[0].ɣ[0].ex, data.alpha[0].ɣ[0].meaning)}>
          <MaterialCommunityIcons name="microphone-outline" color='white' size={70} style={{marginTop: 10, marginRight: 10, backgroundColor: 'black', borderRadius: 50, padding: 5}}/>
          </TouchableOpacity>
          <Text style={styles.micdesc}>Listen</Text>
        </View>
        ...
        <View style={styles.container}>
          <View style={styles.content}>
            <Text style={styles.letter}>{data.alpha[0].nɣ[0].letter}</Text>
            <Text style={styles.sound}>sound: <Text style={styles.bold}>/{data.alpha[0].nɣ[0].sound}/</Text></Text>
            <View style={styles.col}>
              <Text style={styles.example}>Example:   <Text style={styles.bold}>{data.alpha[0].nɣ[0].ex}</Text></Text>
              <Text style={styles.meaning}>Meaning:   <Text style={styles.bold}>{data.alpha[0].nɣ[0].meaning}</Text></Text>
            </View>
          </View>
          <TouchableOpacity style={styles.mic} onPress={()=> Speak(data.alpha[0].nɣ[0].letter, data.alpha[0].nɣ[0].ex, data.alpha[0].nɣ[0].meaning)}>
          <MaterialCommunityIcons name="microphone-outline" color='white' size={70} style={{marginTop: 10, marginRight: 10, backgroundColor: 'black', borderRadius: 50, padding: 5}}/>
          </TouchableOpacity>
          <Text style={styles.micdesc}>Listen</Text>
        </View>
        ...
        <View style={styles.container}>
          <View style={styles.content}>
            <Text style={styles.letter}>{data.alpha[0].ntʃ[0].letter}</Text>
            <Text style={styles.sound}>sound: <Text style={styles.bold}>/{data.alpha[0].ntʃ[0].sound}/</Text></Text>
            <View style={styles.col}>
              <Text style={styles.example}>Example:   <Text style={styles.bold}>{data.alpha[0].ntʃ[0].ex}</Text></Text>
              <Text style={styles.meaning}>Meaning:   <Text style={styles.bold}>{data.alpha[0].ntʃ[0].meaning}</Text></Text>
            </View>
          </View>
          <TouchableOpacity style={styles.mic} onPress={()=> Speak(data.alpha[0].ntʃ[0].letter, data.alpha[0].ntʃ[0].ex, data.alpha[0].ntʃ[0].meaning)}>
          <MaterialCommunityIcons name="microphone-outline" color='white' size={70} style={{marginTop: 10, marginRight: 10, backgroundColor: 'black', borderRadius: 50, padding: 5}}/>
          </TouchableOpacity>
          <Text style={styles.micdesc}>Listen</Text>
        </View>
        ...
        <View style={styles.container}>
          <View style={styles.content}>
            <Text style={styles.letter}>{data.alpha[0].nʒ[0].letter}</Text>
            <Text style={styles.sound}>sound: <Text style={styles.bold}>/{data.alpha[0].nʒ[0].sound}/</Text></Text>
            <View style={styles.col}>
              <Text style={styles.example}>Example:   <Text style={styles.bold}>{data.alpha[0].nʒ[0].ex}</Text></Text>
              <Text style={styles.meaning}>Meaning:   <Text style={styles.bold}>{data.alpha[0].nʒ[0].meaning}</Text></Text>
            </View>
          </View>
          <TouchableOpacity style={styles.mic} onPress={()=> Speak(data.alpha[0].nʒ[0].letter, data.alpha[0].nʒ[0].ex, data.alpha[0].nʒ[0].meaning)}>
          <MaterialCommunityIcons name="microphone-outline" color='white' size={70} style={{marginTop: 10, marginRight: 10, backgroundColor: 'black', borderRadius: 50, padding: 5}}/>
          </TouchableOpacity>
          <Text style={styles.micdesc}>Listen</Text>
        </View>
        ...
        <View style={styles.container}>
          <View style={styles.content}>
            <Text style={styles.letter}>{data.alpha[0].nɲ[0].letter}</Text>
            <Text style={styles.sound}>sound: <Text style={styles.bold}>/{data.alpha[0].nɲ[0].sound}/</Text></Text>
            <View style={styles.col}>
              <Text style={styles.example}>Example:   <Text style={styles.bold}>{data.alpha[0].nɲ[0].ex}</Text></Text>
              <Text style={styles.meaning}>Meaning:   <Text style={styles.bold}>{data.alpha[0].nɲ[0].meaning}</Text></Text>
            </View>
          </View>
          <TouchableOpacity style={styles.mic} onPress={()=> Speak(data.alpha[0].nɲ[0].letter, data.alpha[0].nɲ[0].ex, data.alpha[0].nɲ[0].meaning)}>
          <MaterialCommunityIcons name="microphone-outline" color='white' size={70} style={{marginTop: 10, marginRight: 10, backgroundColor: 'black', borderRadius: 50, padding: 5}}/>
          </TouchableOpacity>
          <Text style={styles.micdesc}>Listen</Text>
        </View>
        ...
        <View style={styles.container}>
          <View style={styles.content}>
            <Text style={styles.letter}>{data.alpha[0].nŋ[0].letter}</Text>
            <Text style={styles.sound}>sound: <Text style={styles.bold}>/{data.alpha[0].nŋ[0].sound}/</Text></Text>
            <View style={styles.col}>
              <Text style={styles.example}>Example:   <Text style={styles.bold}>{data.alpha[0].nŋ[0].ex}</Text></Text>
              <Text style={styles.meaning}>Meaning:   <Text style={styles.bold}>{data.alpha[0].nŋ[0].meaning}</Text></Text>
            </View>
          </View>
          <TouchableOpacity style={styles.mic} onPress={()=> Speak(data.alpha[0].nŋ[0].letter, data.alpha[0].nŋ[0].ex, data.alpha[0].nŋ[0].meaning)}>
          <MaterialCommunityIcons name="microphone-outline" color='white' size={70} style={{marginTop: 10, marginRight: 10, backgroundColor: 'black', borderRadius: 50, padding: 5}}/>
          </TouchableOpacity>
          <Text style={styles.micdesc}>Listen</Text>
        </View>
        ...
        <View style={styles.container}>
          <View style={styles.content}>
            <Text style={styles.letter}>{data.alpha[0].ɣj[0].letter}</Text>
            <Text style={styles.sound}>sound: <Text style={styles.bold}>/{data.alpha[0].ɣj[0].sound}/</Text></Text>
            <View style={styles.col}>
              <Text style={styles.example}>Example:   <Text style={styles.bold}>{data.alpha[0].ɣj[0].ex}</Text></Text>
              <Text style={styles.meaning}>Meaning:   <Text style={styles.bold}>{data.alpha[0].ɣj[0].meaning}</Text></Text>
            </View>
          </View>
          <TouchableOpacity style={styles.mic} onPress={()=> Speak(data.alpha[0].ɣj[0].letter, data.alpha[0].ɣj[0].ex, data.alpha[0].ɣj[0].meaning)}>
          <MaterialCommunityIcons name="microphone-outline" color='white' size={70} style={{marginTop: 10, marginRight: 10, backgroundColor: 'black', borderRadius: 50, padding: 5}}/>
          </TouchableOpacity>
          <Text style={styles.micdesc}>Listen</Text>
        </View>
        ...
        <View style={styles.container}>
          <View style={styles.content}>
            ...
            <View style={styles.col}>
              <Text style={styles.example}>Example:   <Text style={styles.bold}>{data.alpha[0].ɨ[0].ex}</Text></Text>
              <Text style={styles.meaning}>Meaning:   <Text style={styles.bold}>{data.alpha[0].ɨ[0].meaning}</Text></Text>
            </View>
          </View>
          <TouchableOpacity style={styles.mic} onPress={()=> Speak(data.alpha[0].ɨ[0].letter, data.alpha[0].ɨ[0].ex, data.alpha[0].ɨ[0].meaning)}>
          <MaterialCommunityIcons name="microphone-outline" color='white' size={70} style={{marginTop: 10, marginRight: 10, backgroundColor: 'black', borderRadius: 50, padding: 5}}/>
          </TouchableOpacity>
          <Text style={styles.micdesc}>Listen</Text>
        </View>
