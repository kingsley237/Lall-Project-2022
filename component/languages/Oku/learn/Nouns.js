  ...
  showBubbles={false}>
       <View style={styles.container}>
        <Text style={styles.head}>NOUNS</Text>
              ...
              <Text style={styles.keyword}>Sg. Long     Sg. Short</Text>
              <Text style={styles.keyword}>apeemə     apa</Text>
              <Text style={styles.keyword}>Pl. Long     Pl. Short</Text>
              <Text style={styles.keyword}>əpeemə     əpa</Text>
              <View style={styles.move}>
              <MaterialCommunityIcons name="gesture-swipe-left" color='#990099' size={30} style={{bottom: 10,marginRight: 10}}/>
              </View>
        </View>

        <View style={styles.container}>
        <Text style={styles.intro}>All the normal Bantu noun class prefixes will be written as part of the nouns</Text>
              ...
              <View style={styles.title2}>
                ...
                <Text style={styles.top3}>{w2}</Text>
