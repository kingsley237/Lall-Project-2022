...
const data = [
    {
      label: 'Móo\'nə wi á tə́ noŋnə̂ á əkwunə́.'
     },
     {
      label: '  '
     },
     {
        label: 'Móonə á tə́ noŋnə̂ á əkwunə́.'
     },
     {
...
const data2 = [
        {
          label: 'A ghɛlə̂ lə́na ahə̂?'
         },
         {
          label: 'A\' ghɛlə̂n lə́ ahə̂?'
         },
         {
            label: 'A ghɛlə̂ lə́ ahə̂?'
         },
         {
...
const data3 = [
            {
              label: 'Kɔ pɨ ńkə́ sóŋə!'
             },
             {
              label: 'K\'ɔ pɨi ńkə́ sóŋə!'
             },
             {
                label: 'Kɔ pɨ ńkə́ sóŋə nəɨ!'
             },
             {
                label: 'All of the above'
               }
...
const data4 = [
                {
                  label: 'Mǎ ńgyǐəə lə́ ə́fɛ̂, pó gheɛnə̂ lə́'
                 },
                 {
                  label: 'BPó ghǎ ńgyǐəə lə́ ə́fɛ̂, pón ghɛnə̂ lə́'
                 },
                 {
                    label: 'Mǎ ńgyǐəə lə́ ə́fɛ̂, pó ghɛnə̂ lə́'
                 },
                 {
                    label: 'BPó mǎ ńgyǐəə lə́ ə́fɛ̂, pó ghɛnə̂ lə́'
                   }
    ];
...
const data5 = [
                    {
                     ...
                     {
                        label: 'They occur at the beginning and the end of direct speech'
                     },
                     {
                        label: 'None of the above'
                       }
...
function PunctuationEx() {  
    ...
    var db =  database().ref(ref+'/PunctuationExercise');
...
db.child('w1').on('value', snapshot => {
  ...
  return () => database().ref(ref+'/PunctuationExercise').off('child_added', onChildDelete);
  }, []); 
                                ...
                                <View style={styles.content}>
                                            <Text style={styles.question}>{w1}</Text>
                                                    <View style={styles.radio}>
                                                        ...
                                                        duration={300}
                                                        activeColor={'#FFCC66'}
                                                        boxActiveBgColor={'rgb(253,220,153)'}
                                                            data={data}
