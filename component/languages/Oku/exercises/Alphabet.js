...
const data2 = [
        {
          label: '6 vowels and 23 consonants'
         },
         {
          label: '7 vowels and 22 consonants'
         },
         {
            label: '9 vowels and 22 consonants'
         },
         {
            label: '6 vowels and 25 consonants'
           }
    ];
const data3 = [
            {
                                ...
                                <View style={styles.content}>
                                            <Text style={styles.question}>{w1}</Text>
                                                    <View style={styles.radio}>
                                                        ...
                                                        duration={300}
                                                        activeColor={'magenta'}
                                                        boxActiveBgColor={'rgb(255,198,255)'}
                                                            data={data}
