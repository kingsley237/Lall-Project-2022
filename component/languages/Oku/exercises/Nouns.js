...
function NounsExercise() {    
    ...
    var db =  database().ref(ref+'/NounExercise');
...
db.child('w1').on('value', snapshot => {
  ...
  return () => database().ref(ref+'/NounExercise').off('child_added', onChildDelete);
  }, []); 
                                ...
                                <View style={styles.content}>
                                            <Text style={styles.question}>{w1}</Text>
                                                    <View style={styles.radio}>
                                                        ...
                                                        duration={300}
                                                        activeColor={'#990099'}
                                                        boxActiveBgColor={'rgb(226,177,248)'}
                                                            data={data}
