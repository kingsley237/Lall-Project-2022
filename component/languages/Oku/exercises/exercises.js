    ...
    return (
      <ScrollView keyboardShouldPersistTaps='always' contentContainerStyle={{ height: 1840, justifyContent: 'center', backgroundColor: 'white' }}>
        <View style={styles.container}>
           <Text style={styles.title}>EXERCISES</Text> 
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                        <View style={{width: 310, height: 200, alignItems: 'center'}}>
                     <FastImage source={require('../../../../img/wordEx.png')} style={{height: 300, width: 300}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
                     <MaterialCommunityIcons name="ab-testing" color='black' size={20} style={{marginTop: 10, marginRight: 10,}}/>
        <Text style={styles.text1}>Word Division</Text>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                        <View style={{width: 310, height: 200, alignItems: 'center'}}>
                     <FastImage source={require('../../../../img/noun2.gif')} style={{height: 300, width: 350}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
        ...
        <Text style={styles.text1}>Punctuation</Text>     
          ...
          {/* <View style={styles.option1}>
           <MaterialCommunityIcons name="charity" color='black' size={20} style={{marginTop: 10, marginRight: 10,}}/>
        <Text style={styles.text1}>Orthography</Text>
        <TouchableOpacity style={styles.button1} onPress={()=> navigation.navigate('verbEx')}><Text style={styles.buttontext}>Launch Exercise</Text></TouchableOpacity>
          </View> */}
           </View>
        </View>
        </ScrollView>
