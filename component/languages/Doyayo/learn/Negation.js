...
function Punctuation() { 
    ...
    var db =  database().ref(ref+'/Negation');
            ...
            <Carousel
                ...
                showBubbles={false}>
                        <View style={styles.container}>
                                    <Text style={styles.head}>NEGATIVES</Text>
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>{w1}</Text>
                                    <Text style={styles.intro}>
                                {w2} <Text style={styles.small}>2</Text> {w3} 
                                </Text>
                                <Text style={styles.keyword}>Examples{"\n"}</Text>
                                <Text style={styles.keyword}>zaa <Text style={styles.small}>23</Text> - za <Text style={styles.small}>1</Text>/ zaa <Text style={styles.small}>2</Text> gɛɛ <Text style={styles.small}>23</Text>{"\n"}</Text>                                
                                <Text style={styles.keyword}>{w4}</Text>
                                <View style={styles.move}>
                            <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#330000' size={30} style={{marginBottom: 10, marginRight: 15,}}/> 
              </View>
                        </View>

                        <View style={styles.container}>
                                    <Text style={styles.head2}>{w5}</Text>
                                    <Text style={styles.intro}>
                                {w6} <Text style={styles.small}>12</Text>
                                </Text>
                                <Text style={styles.keyword}>Examples{"\n"}</Text>
                                <Text style={styles.keyword}>hi <Text style={styles.small}>1</Text> taa <Text style={styles.small}>12</Text> zaa<Text style={styles.small}>1</Text> - ko <Text style={styles.small}>3</Text>{"\n"}</Text>                                
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>Negative Imperative</Text>
                                    <Text style={styles.intro}>
                                {w8} <Text style={styles.small}>2</Text> {w9}
                                </Text>
                                <Text style={styles.keyword}>Examples{"\n"}</Text>
                                <Text style={styles.keyword}>bɔ <Text style={styles.small}>2</Text> mɔ <Text style={styles.small}>1</Text> re<Text style={styles.small}>3</Text>k-ɔ <Text style={styles.small}>3</Text>{"\n"}</Text>                                
