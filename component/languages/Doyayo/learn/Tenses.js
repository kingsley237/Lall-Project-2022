  ...
  setw43("N/A");
    ...
    return (
        ...
        <Text style={styles.head}>TENSES</Text>
              ...
              {intro} <Text style={styles.bold}>Doyayo.</Text>
              </Text>
       ...
       <View style={styles.content}>
                        <View style={{marginTop: 50}}></View>
                            <Text style={styles.head}>Aorist Tense</Text>
                            <Text style={styles.intro}>
                              {w1}
                            </Text>
                            <Text style={styles.keyword}></Text>
                            <Text style={styles.keyword}>Example:{"\n"}</Text>
                            <Text style={styles.keyword}>mi<Text style={{fontSize: 10, top: 50}}> 3</Text> kpe<Text style={{fontSize: 10, top: 50}}>4 </Text>lɔ<Text style={{fontSize: 10, top: 50}}>4</Text>  |   kpe<Text style={{fontSize: 10, top: 50}}>4 </Text> lɔ<Text style={{fontSize: 10, top: 50}}>4</Text>   |  mi<Text style={{fontSize: 10, top: 50}}>3 </Text>tɔɔ<Text style={{fontSize: 10, top: 50}}>3</Text> tɔ<Text style={{fontSize: 10, top: 50}}>1</Text>{"\n"}</Text>
                        ...
                        <View style={{marginTop: 60}}></View>
                            <Text style={styles.head}>Remote Future</Text>
                            <Text style={styles.intro}>
                              {w3}
                            </Text>
                            <Text style={styles.keyword}></Text>
                            <Text style={styles.keyword}>Example:{"\n"}</Text>
                            <Text style={styles.keyword}>mi<Text style={{fontSize: 10, top: 50}}> 1</Text> kpe<Text style={{fontSize: 10, top: 50}}>4 </Text>lɔ<Text style={{fontSize: 10, top: 50}}>4</Text>  |   gi<Text style={{fontSize: 10, top: 50}}>1 </Text> kpe<Text style={{fontSize: 10, top: 50}}>4 </Text> lɔ<Text style={{fontSize: 10, top: 50}}>4</Text>   |  mi<Text style={{fontSize: 10, top: 50}}>1 </Text>tɔɔ<Text style={{fontSize: 10, top: 50}}>3</Text> tɔ<Text style={{fontSize: 10, top: 50}}>1</Text>{"\n"}</Text>
                         ...
                         <View style={styles.content}>
                        <View style={{marginTop: 60}}></View>
                            <Text style={styles.head}>The Present</Text>
                            <Text style={styles.intro}>
                            {w5}<Text style={{fontSize: 10, top: 50}}> 3</Text> {w6}
                            </Text>
                            <Text style={styles.keyword}></Text>
                            <Text style={styles.keyword}>Example:{"\n"}</Text>
                            <Text style={styles.keyword}>kpel-k<Text style={{fontSize: 10, top: 50}}> 1</Text> mɛm<Text style={{fontSize: 10, top: 50}}> 1</Text>{"\n"}</Text>
                        ...
                        <View style={styles.content}>
                            <Text style={styles.head}>The Proximate</Text>
                        <View style={{marginTop: 60}}></View>
                            <Text style={styles.intro}>
                           {w8}
                            </Text>
                            <Text style={styles.keyword}></Text>
                            <Text style={styles.keyword}>Example:{"\n"}</Text>
                            <Text style={styles.keyword}>kpel<Text style={{fontSize: 10, top: 50}}> 1</Text> -ko<Text style={{fontSize: 10, top: 50}}> 1</Text>{"\n"}</Text>
