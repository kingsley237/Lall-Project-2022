    ...
    return ( 
      ...
      <ScrollView keyboardShouldPersistTaps='always' contentContainerStyle={{ height: 2270, justifyContent: 'center', backgroundColor: 'white' }}>
        <View style={styles.container}>
           <Text style={styles.title}>LEARN</Text>
            ...
            <Button style={{width: 150, bottom: 45}}
                      ...
                      mode="outlined"
                      >
                        About<Text style={{color: "blue"}}> DOYAYO</Text>             
                     </Button>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1}}>
                     ...
                     <FastImage source={{uri:'https://cdn.dribbble.com/users/362027/screenshots/3353903/people.gif'}} style={{height: 270, width: 350}}/>
                     </View>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                        <View style={{width: 310, height: 200, alignItems: 'center'}}>
                     <FastImage source={{uri:'https://cdn.dribbble.com/users/516449/screenshots/3408137/comp_2_10.gif'}} style={{height: 300, width: 350}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
                           <MaterialCommunityIcons name="pencil-plus" color='black' size={20} style={{marginTop: 10, marginRight: 15,}}/> 
        ...
        <Text style={styles.text1}>Negation</Text>     
            ...
            <Text style={styles.text1}>Verb Phrases</Text>      
                              </View>
                     <Button style={styles.button1}
                      onPress={()=> verbs()}
                      uppercase={false}
