   ...
   langInfo.child('info').on('value', snapshot => {  
    ...
    return (
        <ScrollView contentContainerStyle={{backgroundColor: 'white', height: 1550}}>
                <FastImage source={{uri: 'https://live.staticflickr.com/6125/5931621095_7a11a98240_z.jpg'}} style={{height: 380, width: Dimensions.get("window").width, bottom: 50, marginBottom: 70}}/>
                        <View style={{bottom: 60}}>
                        <Text style={styles.head}>Doyayo</Text>
                        <Divider/>
                        </View>
      ...
      <DataTable.Row>
        <DataTable.Cell>Doyayo</DataTable.Cell>
