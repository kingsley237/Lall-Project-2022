...
const data2 = [
        {
          label: 'To be lying down'
         },
         {
          label: 'To be standing'
         },
         {
            label: 'To possess'
         },
...
const data4 = [
                {
                 ...
                 {
                    label: 'to be looking at something'
                   }
    ];
const data5 = [
                    {
                     ...
                     {
                      label: 'to be possessing something'
                     },
                     {
            ...
            color="grey">
                        ...
                        <Text style={styles.intro}>
                            <Text style={styles.bold}>Note: </Text>Refer to the Verbs section and answer the questions posed.</Text>
                                <View style={styles.content}>
                                            <Text style={styles.question}>What is the "each other" affix of a verb?</Text>
                ...
                <View style={styles.container}>
                        <Text style={styles.intro}>
                            <Text style={styles.bold}>Note: </Text>Refer to the Verbs section and answer the questions posed.</Text>
                                <View style={styles.content}>
                                            <Text style={styles.question}>"bô" translates to?</Text>
                                                    <View style={styles.radio}>
                                                        <RadioButtonRN
                                                        duration={300}
                                                        activeColor={'grey'}
                ...
                <View style={styles.container}>
                        <Text style={styles.intro}>
                            <Text style={styles.bold}>Note: </Text>Refer to the Verbs section and answer the questions posed.</Text>
                                <View style={styles.content}>
                                            <Text style={styles.question}>Radical verbs could have one syllable witht the addition on an unaccented vowel</Text>
                                                    <View style={styles.radio}>
                                                        <RadioButtonRN
                                                        duration={300}
                                                        activeColor={'grey'}
                ...
                <View style={styles.container}>
                        <Text style={styles.intro}>
                            <Text style={styles.bold}>Note: </Text>Refer to the Verbs section and answer the questions posed.</Text>
                                <View style={styles.content}>
                                            <Text style={styles.question}>"lô" translates to?</Text>
                                                    <View style={styles.radio}>
                                                        <RadioButtonRN
                                                        duration={300}
                                                        activeColor={'grey'}
                ...
                <View style={styles.container}>
                        <Text style={styles.intro}>
                            <Text style={styles.bold}>Note: </Text>Refer to the Verbs section and answer the questions posed.</Text>
                                <View style={styles.content}>
                                            <Text style={styles.question}>"bete" translates to?</Text>
                                                    <View style={styles.radio}>
                                                        <RadioButtonRN
                                                        duration={300}
                                                        activeColor={'grey'}
