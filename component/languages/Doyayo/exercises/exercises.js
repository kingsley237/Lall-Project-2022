...
function exercises({navigation}) {
   ...
   var c =  database().ref(ref+'/Suffixes');
   var d =  database().ref(ref+'/VerbPhrases');
 ...
 return () => database().ref(ref).off('child_added', onChildDelete);
   ...
   e.child('disable').on('value', snapshot => {          
    ...
    return ( 
      ...
      <ScrollView keyboardShouldPersistTaps='always' contentContainerStyle={{ height: 1840, justifyContent: 'center', backgroundColor: 'white' }}>
        <View style={styles.container}>
           <Text style={styles.title}>EXERCISES</Text> 
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                        <View style={{width: 310, height: 200, alignItems: 'center'}}>
                     <FastImage source={{uri:'https://cdn.dribbble.com/users/2424870/screenshots/9659021/media/afa2e4e9d027106ceeec76c7917d3d3b.gif'}} style={{height: 300, width: 350, left: 10}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
                           <MaterialCommunityIcons name="account-voice" color='black' size={20} style={{marginTop: 10, marginRight: 15,}}/> 
            <Text style={styles.text1}>Suffixes</Text>       
                              </View>
                     <Button style={styles.button1}
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                        <View style={{width: 310, height: 200, alignItems: 'center'}}>
                     <FastImage source={{uri:'https://thumbs.dreamstime.com/b/unhappy-angry-brunette-woman-showing-crossed-hands-sign-gesture-meaning-to-stop-s-enough-symbol-refusal-denial-negative-201297741.jpg'}} style={{height: 300, width: 350}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
