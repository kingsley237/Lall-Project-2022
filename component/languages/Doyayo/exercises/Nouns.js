...
function NounsExercise() {  
    ...
    var db =  database().ref(ref+'/SuffixesExercise');
...
db.child('w1').on('value', snapshot => {
  ...
  return () => database().ref(ref+'/SuffixesExercise').off('child_added', onChildDelete);
  }, []);
            ...
            color="#5ff232">
                ...
                <View style={styles.container}>
                        ...
                        <Text style={styles.intro}>
                            <Text style={styles.bold}>Note: </Text>Refer to the Suffixes section and answer the questions posed.</Text>
