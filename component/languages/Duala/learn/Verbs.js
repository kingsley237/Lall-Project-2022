  ...
  setw43("N/A");
    ...
    return (
        ...
        <Text style={styles.head}>VERBS</Text>
              ...
              <MaterialCommunityIcons name="gesture-swipe-left" color='grey' size={30} style={{marginTop: 10, marginRight: 10}}/>
              </View>
        </View>

        <View style={styles.container}>
        <Text style={styles.head}>INDICATIVE MODE</Text>
        <View style={{marginTop: 10}}></View>
              <Text style={styles.intro}>
              {w3}
              </Text>
              <View style={styles.move}>
              <MaterialCommunityIcons name="gesture-swipe-horizontal" color='grey' size={30} style={{marginTop: 10, marginRight: 10}}/>
              </View>
        </View>

        <View style={styles.container}>
        <Text style={styles.head}>INFINITIVE MODE</Text>
        ...
        <View style={styles.container}>
        <Text style={styles.head}>IMPERATIVE MODE</Text>
        <View style={{marginTop: 80}}></View>
              <Text style={styles.intro}>
              {w7}
              </Text>
        ...
        <View style={styles.container}>
        <Text style={styles.head}>OPTATIVE MODE</Text>
        <View style={{marginTop: 80}}></View>
              <Text style={styles.intro}>
              {w10}
              </Text>
              ...
              <View style={styles.move}>
              <MaterialCommunityIcons name="gesture-swipe-right" color='grey' size={30} style={{marginTop: 10, marginRight: 10}}/>
              </View>
        </View>   
            </Carousel>
