        ...
        <View style={styles.container}>
           <Text style={styles.title}>LEARN</Text>
            ...
            <Button style={{width: 150, bottom: 45}}
                      ...
                      mode="outlined"
                      >
                        About<Text style={{color: "blue"}}> DUALA</Text>             
                     </Button>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1}}>
                     ...
                     <FastImage source={{uri:'https://i.pinimg.com/originals/dd/f7/62/ddf7620b1a1af96d24f1413bb336f096.gif'}} style={{height: 250, width: 350, left: 5, top: 15}}/>
                     </View>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                        <View style={{width: 310, height: 200, alignItems: 'center'}}>
                     <FastImage source={{uri:'https://i.pinimg.com/736x/84/f1/b3/84f1b32e6257f6362be14a0a0965b865.jpg'}} style={{height: 300, width: 350}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                        <View style={{width: 310, height: 200, alignItems: 'center'}}>
                     <FastImage source={{uri:'https://img.freepik.com/free-vector/conversation-concept-illustration_114360-1102.jpg?size=626&ext=jpg&ga=GA1.2.2140631430.1627344000'}} style={{height: 300, width: 350}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
