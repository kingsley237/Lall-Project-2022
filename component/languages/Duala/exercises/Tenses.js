...
const data = [
    {
     ...
     {
      label: 'the vowel of the radix should be converted to a low tone'
     },
     {
        label: 'the fundamental form is eliminated and the suffix i- is added.'
     },
     {
        label: 'prefix ma- is added to the fundamental form'
       }
    ];
...
const data5 = [
                    {
                     ...
                     {
                      label: 'A verbal pronoun'
                     },
                     {
                        label: 'A finished action'
                     },
                     {
                        label: 'None of the above'
                       }
