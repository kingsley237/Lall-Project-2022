...
const data5 = [
                    {
                      label: 'njá nú málē̠ wóne̠'
                     },
                     {
                      label: 'njá ne wóne̠ tyo'
                     },
                     {
                        label: 'nú njá málē̠ wóne̠'
                     },
                     {
                        label: 'None of the above'
                       }
...
db.child('w1').on('value', snapshot => {
  ...
  if(w1 === "" || w2 === "" || w3 === "" || w4 === "" || w5 === ""){
    ...
    function tip(){
        Alert.alert(
          "Tip",
          "it translates to -angó in Duala",
          [
            {
              text: "Cancel",
              style: "cancel"
            ...
            color="#003366">
                ...
                <View style={styles.container}>
                        ...
                        <Text style={styles.intro}>
                            <Text style={styles.bold}>Note: </Text>Refer to the Prounouns section and answer the questions posed.</Text>
