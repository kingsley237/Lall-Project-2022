   ...
   langInfo.child('info').on('value', snapshot => {  
    ...
    return (
        <ScrollView contentContainerStyle={{backgroundColor: 'white', height: 1550}}>
                <FastImage source={{uri: 'http://stevenlevourch.smugmug.com/Travelling-throughout-the/Cameroon/IMG0757-copy/115055440_qt88P-L.jpg'}} style={{height: 370, width: Dimensions.get("window").width, }}/>
                        <View style={{top: 50, marginBottom: 100}}>
                        <Text style={styles.head}>Duala</Text>
                        <Divider/>
                        </View>
      ...
      <DataTable.Row>
        <DataTable.Cell>Duala</DataTable.Cell>
      ...
      <DataTable.Row>
        ...
        <DataTable.Cell>87, 700</DataTable.Cell>
        <DataTable.Cell numeric>As of 1982.</DataTable.Cell>
      </DataTable.Row>
