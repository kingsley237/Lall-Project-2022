...
<View style={styles.move}>
        ...
        <View style={styles.container}>
        <Text style={styles.head2}>MORE EXAMPLES</Text>
...
<DataTable.Row>
  <DataTable.Cell>{w33}</DataTable.Cell>
  <DataTable.Cell numeric>{w34}</DataTable.Cell>
</DataTable.Row>
<DataTable.Row>
  <DataTable.Cell>{w35}</DataTable.Cell>
  <DataTable.Cell numeric>{w36}</DataTable.Cell>
</DataTable.Row>
<DataTable.Row>
  <DataTable.Cell>{w37}</DataTable.Cell>
  <DataTable.Cell numeric>{w38}</DataTable.Cell>
</DataTable.Row>
