...
function NounsExercise() {     
    ...
    var db =  database().ref(ref+'/WordsExercise');
...
db.child('w1').on('value', snapshot => {
  ...
  return () => database().ref(ref+'/WordsExercise').off('child_added', onChildDelete);
  }, []);
            ...
            color="#5ff232">
                ...
                <View style={styles.container}>
                        ...
                        <Text style={styles.intro}>
                            <Text style={styles.bold}>Note: </Text>Refer to the Words section and answer the questions posed.</Text>
