...
const data5 = [
                    {
                      label: 'I stayed by his side'
                     },
                     {
                      label: 'He did not kill him immediately'
                     },
                     {
                        label: 'We will send the news'
                     },
                     {
                        label: 'None of the above'
                       }
...
function VerbsEx() {      
    ...
    var db =  database().ref(ref+'/PhrasesExercise');
...
db.child('w1').on('value', snapshot => {
  ...
  return () => database().ref(ref+'/PhrasesExercise').off('child_added', onChildDelete);
  }, []);
            ...
            color="grey">
                ...
                <View style={styles.container}>
                        ...
                        <Text style={styles.intro}>
                            <Text style={styles.bold}>Note: </Text>Refer to the Phrases section and answer the questions posed.</Text>
