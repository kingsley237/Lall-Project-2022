...
function learn({navigation}) {
   ...
   var a =  database().ref(ref+'/Salutation');
        ...
        <View style={styles.container}>
           <Text style={styles.title}>LEARN</Text>
            ...
            <Button style={{width: 150, bottom: 45}}
                      ...
                      mode="outlined"
                      >
                        About<Text style={{color: "blue"}}> GBAYA</Text>             
                     </Button>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1}}>
                     ...
                     <FastImage source={{uri:'https://assets-global.website-files.com/5bcb46130508ef456a7b2930/5cf343d473a6232713b2bdb7_illustration-2-animated-export-v0.3.gif'}} style={{height: 250, width: 350, left: 5, top: 15}}/>
                     </View>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                        <View style={{width: 310, height: 200, alignItems: 'center'}}>
                        {/*Original image: require('../../../../img/salutation.jpg') */}
                     <FastImage source={{uri:'https://img.freepik.com/free-vector/happy-female-friends-talking-while-having-coffee_202358-27.jpg?size=338&ext=jpg'}} style={{height: 300, width: 350}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
                              <MaterialCommunityIcons name="human-greeting" color='black' size={20} style={{marginTop: 10, marginRight: 15,}}/> 
               <Text style={styles.text1}>Salutations</Text>     
                              </View>
                     <Button style={styles.button1}
                      onPress={()=> tenses()}
                      uppercase={false}
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                        <View style={{width: 310, height: 200, alignItems: 'center'}}>
                     <FastImage source={{uri:'https://cdn.dribbble.com/users/4908/screenshots/2657565/livechat-animation.gif'}} style={{height: 300, width: 350}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
