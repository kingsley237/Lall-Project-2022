    ...
    return (
            <Carousel
                ...
                showBubbles={false}>
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>Ode</Text>
                                    <Text style={styles.intro}>
                                {w1}
                                </Text>
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>De</Text>
                                    <Text style={styles.intro}>
                              {w4}
                                </Text>
                                <Text style={styles.keyword}>Examples{"\n"}</Text>
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>Só</Text>
                                    <Text style={styles.intro}>
                               {w7}
                                </Text>
                                <Text style={styles.keyword}>Examples{"\n"}</Text>
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>a/á</Text>
                                    <Text style={styles.intro}>
                                  {w10}
                                </Text>
                                <Text style={styles.keyword}>Examples{"\n"}</Text>
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>Kina ode</Text>
                                    <Text style={styles.intro}>
                               {w13}
                                </Text>
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>Ndé</Text>
                                    <Text style={styles.intro}>
                              {w16}
                                </Text>
                                <Text style={styles.keyword}>Example{"\n"}</Text>
                                <Text style={styles.keyword}>{w17}{"\n"}</Text>                                
                                <Text style={styles.keyword}>{w18}</Text>
                                <View style={styles.move}>
