...
const data = [
    {
      label: 'I am not visiting'
     },
     {
      label: 'Alright, she is not leaving'
     },
     {
...
const data2 = [
        {
         ...
         {
            label: 'No such negation in Baka'
         }
    ];

const data3 = [
            {
              label: 'She hasn\'eaten the banana'
             },
             {
              label: 'Rain stopped a while'
             },
             {
                label: 'I\'ve not met her yet'
             },
             {
...
const data4 = [
                {
                 ...
                 {
                  label: 'ma jo ndɔ́ só'
                 },
                 {
                    label: 'ma mɛɛ̀ là bèlà kina ode'
                 },
                 {
                    label: 'None of the above'
                   }
...
function PunctuationEx() { 
    ...
    var db =  database().ref(ref+'/NegationExercise');
...
db.child('w1').on('value', snapshot => {
  ...
  return () => database().ref(ref+'/NegationExercise').off('child_added', onChildDelete);
  }, []);
  ...
  if(w1 === "" || w2 === "" || w3 === "" || w4 === "" || w5 === ""){
    ...
    function tip(){
        Alert.alert(
          "Tip",
          "It translates to \"the people are not there\"",
          [
            {
              text: "Cancel",
              style: "cancel"
