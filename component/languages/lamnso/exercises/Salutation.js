...
function SalutationEx() {        
    ...
    var db =  database().ref(ref+'/SalutationExercise');
...
db.child('w1').on('value', snapshot => {
  ...
  return () => database().ref(ref+'/SalutationExercise').off('child_added', onChildDelete);
  }, []);  
            ...
            color="yellow">
                ...
                <View style={styles.container}>
                        ...
                        <Text style={styles.intro}>
                            <Text style={styles.bold}>Note: </Text>Refer to the Salutation section and answer the questions posed.</Text>
