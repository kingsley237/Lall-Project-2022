   ...
   langInfo.child('info').on('value', snapshot => {  
    ...
    return (
        <ScrollView contentContainerStyle={{backgroundColor: 'white', height: 1550}}>
                <FastImage source={{uri: 'https://1.bp.blogspot.com/-UqFUoCudTmc/X0eTO2PfKcI/AAAAAAAAPA0/dfJZMwoNgvM0kB82j2J4ijmHzi0MxNzRQCLcBGAsYHQ/s1600/15843958_10209905041414416_3666313330648999025_o%2Bnso.jpg'}} style={{height: 360, width: Dimensions.get("window").width, bottom: 150,}}/>
                        <View style={{bottom: 60}}>
                        <Text style={styles.head}>Lamnso</Text>
                        <Divider/>
                        </View>
      ...
      <DataTable.Row>
        <DataTable.Cell>Lamnso</DataTable.Cell>
      ...
      <DataTable.Row>
        ...
        <DataTable.Cell numeric>See reference.</DataTable.Cell>
      </DataTable.Row>
