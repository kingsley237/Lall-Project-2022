        ...
        <View style={styles.container}>
           <Text style={styles.title}>LEARN</Text>
            ...
            <Button style={{width: 150, bottom: 45}}
                      ...
                      mode="outlined"
                      >
                        About<Text style={{color: "blue"}}> LAMNSO</Text>             
                     </Button>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1}}>
                     ...
                     <FastImage source={require('../../../../img/alphabet2.gif')} style={{height: 250, width: 350, left: 5, top: 15}}/>
                     </View>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                     ...
                     <FastImage source={{uri:'https://static.vecteezy.com/system/resources/previews/002/556/961/non_2x/young-man-gesture-and-say-hi-free-vector.jpg'}} style={{height: 300, width: 350}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                        <View style={{width: 310, height: 200, alignItems: 'center'}}>
                     <FastImage source={require('../../../../img/word.gif')} style={{height: 300, width: 350}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
