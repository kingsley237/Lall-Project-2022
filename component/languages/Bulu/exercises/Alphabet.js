...
const data = [
    {
     ...
     {
        label: 'It is\'nt a tonal language'
       }
    ];
const data2 = [
        {
          label: 'Between two vowels'
         },
         {
          label: 'Before a glottal stop'
         },
         {
            label: 'When the verb is in the imperitive form'
         },
         {
            label: 'When the preceding letter is a vowel'
           }
    ];
const data3 = [
            {
...
const data5 = [
                    {
                      label: 'Great number of words in which vowels are the same'
                     },
                     {
                      label: 'A large proportiong of nouns are monosyllables'
                     },
                     {
                        label: 'A question in Bulu leaves the tone unchanged'
                     },
                     {
                        label: 'All the above suggestions'
                       }
     ];
