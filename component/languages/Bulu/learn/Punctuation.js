...
function Punctuation() {
      ...
      return () => database().ref(ref+'/Negation').off('child_added', onChildAdd);
      }, [])
      ...
      return () => database().ref(ref+'/Negation').off('child_added', onChildDelete);
      }, []);
    return (
            <Carousel
                ...
                showBubbles={false}>
                        <View style={styles.container}>
                                ...
                                {intro} <Text style={styles.bold}>Bulu </Text>{w1}
                                </Text>
                          <View style={styles.move}>
                          <MaterialCommunityIcons name="gesture-swipe-left" color='#330000' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
                          </View>
                        </View>

                        <View style={styles.container}>
                                    <Text style={styles.head}>NJI</Text>
                                    <Text style={styles.intro}>
                               {w2}
                                </Text>
                                ...
                                <Text style={styles.keyword}>{w4}</Text>
                                    <View style={styles.move}>
                                  <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#330000' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
                                  </View>
                        </View>

                        <View style={styles.container}>
                                    <Text style={styles.head}>TE</Text>
                                    <Text style={styles.intro}>
                               {w5}
                                </Text>
                                <Text style={styles.keyword}>Examples{"\n"}</Text>
              ...
              <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#330000' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>SE</Text>
                                    <Text style={styles.intro}>
                               {w8}
                                </Text>
                                <Text style={styles.keyword}>Examples{"\n"}</Text>
              ...
              <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#330000' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>SA</Text>
                                    <Text style={styles.intro}>
                               {w11}
                                </Text>
                                <Text style={styles.keyword}>Examples{"\n"}</Text>
              ...
              <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#330000' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>ZA</Text>
                                    <Text style={styles.intro}>
                               {w14}
                                </Text>
              ...
              <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#330000' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>ETE or NTE</Text>
                                    <Text style={styles.intro}>
                               {w17}
                                </Text>
                                <Text style={styles.keyword}>Example{"\n"}</Text>
              ...
              <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#330000' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
                        ...
                        <View style={styles.container}>
                                    <Text style={styles.head}>MOMO or KOO</Text>
                                    <Text style={styles.intro}>
                               {w20}
                                </Text>
                                <Text style={styles.keyword}>Example{"\n"}</Text>
                                ...
                                <View style={styles.move}>
                                  <MaterialCommunityIcons name="gesture-swipe-right" color='#330000' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
                                  </View>
                        </View>
