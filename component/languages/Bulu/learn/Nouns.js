...
return () => database().ref(ref+'/Nouns').off('child_added', onChildAdd);
}, [])
...
return () => database().ref(ref+'/Nouns').off('child_added', onChildDelete);
}, []);
    return (
  ...
  showBubbles={false}>
       <View style={styles.container}>
        <Text style={styles.head}>NOUNS</Text>
              <Text style={styles.intro}>{intro} <Text style={styles.bold}>{w1} </Text></Text>
             <View style={styles.move}>
              <MaterialCommunityIcons name="gesture-swipe-left" color='#5ff232' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
              </View>
        </View>
        ...
        <View style={styles.container}>
          <Text style={styles.head2}>Classes 1 & 2</Text>
              ...
              {w2} </Text>
                <Text style={styles.keyword}><Text style={styles.bold}>Class 1 nouns</Text></Text>
                <Text style={styles.keyword}>{w3}</Text>
                <Text style={styles.keyword}>{w4}</Text>
                <Text style={styles.keyword}>{w5}</Text>
                <Text style={styles.keyword}>{w6}</Text>
                <Text style={styles.keyword}>{w7}</Text>
                <View style={styles.move}>
              <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
              </View>
        </View>

        <View style={styles.container}>
        <Text style={styles.head2}>Plural of nouns</Text>
              <Text style={styles.intro}>
               {w8}
            </Text>
              <Text style={styles.keyword}>Example:</Text>
              <Text style={styles.keyword}>{w9}</Text>
              <Text style={styles.keyword}><Text style={styles.keyword}>{w10}</Text></Text>
             <View style={styles.move}>
              <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
              </View>
        </View>
                      ...
                      <View style={styles.container}>
                        <View style={{marginTop: 150}}></View>
                            <Text style={styles.head}>Nouns as adjectives</Text>
                            <Text style={styles.intro}>
                              <Text style={styles.bold}>1.  </Text> {w11}{'\n'}{'\n'}               
                              <Text style={styles.bold}>2.  </Text> {w12}{'\n'}{'\n'} 
                              <Text style={styles.bold}>3.  </Text> {w13}{'\n'}{'\n'} 
        ...
        <View style={styles.container}>
        <Text style={styles.head2}>The connective YE or NYA</Text>
              <Text style={styles.intro}>
            {w14}</Text>
             <View style={styles.move}>
              <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
        ...
        <View style={styles.container}>
        <Text style={styles.head2}>Nouns in the genitive relation</Text>
              <Text style={styles.intro}>
                {w15}
              </Text>
              <Text style={styles.keyword}>Example:</Text>
              <Text style={styles.keyword}>{w16}    <Text style={styles.keyword}>        {w18}</Text></Text>
              <Text style={styles.keyword}>{w17}     <Text style={styles.keyword}>   {w19}</Text></Text>
             <View style={styles.move}>
              <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
              </View>
        </View>
        ...
        <View style={styles.container}>
        <Text style={styles.head2}>Gender of nouns</Text>
              <Text style={styles.intro}>
           {w20}</Text>
              <Text style={styles.keyword}>Example:</Text>
              <Text style={styles.keyword}>{w21}    <Text style={styles.keyword}>         man</Text></Text>
              <Text style={styles.keyword}>{w22}     <Text style={styles.keyword}>       woman</Text></Text>
              <Text style={styles.keyword}>{w23}     <Text style={styles.keyword}>   boy</Text></Text>
              <Text style={styles.keyword}>{w24}     <Text style={styles.keyword}> girl</Text></Text>
             <View style={styles.move}>
              <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
              </View>
        </View>
        ...
        <View style={styles.container}>
        <Text style={styles.head2}>Noun modifier</Text>
              <Text style={styles.intro}>
            {w25}</Text>
            <View style={styles.move}>
              <MaterialCommunityIcons name="gesture-swipe-right" color='#5ff232' size={50} style={{marginBottom: 10, marginRight: 15,}}/> 
              </View>
        </View>
