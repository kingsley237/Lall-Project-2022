   ...
   langInfo.child('info').on('value', snapshot => {  
    ...
    return (
        <ScrollView contentContainerStyle={{backgroundColor: 'white', height: 1550}}>
                <FastImage source={{uri: 'https://www.soul-of-africa.com/files/content/ausstellungen/kamerun/3_C-20100205-010.jpg'}} style={{height: 370, width: Dimensions.get("window").width, }}/>
                        <View style={{top: 50, marginBottom: 100}}>
                        <Text style={styles.head}>Bulu</Text>
                        <Divider/>
                        </View>
      ...
      <DataTable.Row>
        <DataTable.Cell>Bulu</DataTable.Cell>
        <DataTable.Cell >Language</DataTable.Cell>
        <DataTable.Cell numeric>See above.</DataTable.Cell>
      </DataTable.Row>

      <DataTable.Row>
        <DataTable.Cell>Speakers</DataTable.Cell>
        <DataTable.Cell>86, 000</DataTable.Cell>
        <DataTable.Cell numeric>As of 2007.</DataTable.Cell>
      </DataTable.Row>

      <DataTable.Row>
        <DataTable.Cell>Crops</DataTable.Cell>
        <DataTable.Cell>Cassava, corn</DataTable.Cell>
        <DataTable.Cell numeric>plantains, oil</DataTable.Cell>
      </DataTable.Row>
