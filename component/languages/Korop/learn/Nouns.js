  ...
  showBubbles={false}>
       <View style={styles.container}>
        <Text style={styles.head}>NOUNS</Text>
             ...
             <MaterialCommunityIcons name="gesture-swipe-left" color='#5ff232' size={30} style={{marginRight: 15,}}/> 
             </View>
             
        </View>

        <View style={styles.container}>
        <Text style={styles.head}>Uncountable nouns</Text>
              <Text style={styles.intro}>
            {w1}
             </Text>
              <Text style={styles.keyword}>Examples:</Text>
              <Text style={styles.keyword}>é-sén è-nì    <Text style={styles.keyword2}> {w6}</Text></Text>
              <Text style={styles.keyword}>í-sén ì-wàn     <Text style={styles.keyword2}>{w7}</Text></Text>
              <Text style={styles.keyword}>bú-sén     <Text style={styles.keyword2}> {w8}</Text></Text>
              <Text style={styles.keyword}>ká-kám     <Text style={styles.keyword2}> {w9}</Text></Text>
              <Text style={styles.keyword}>bá-kám    <Text style={styles.keyword2}> {w10}</Text></Text>
              <View style={styles.move}>
             <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={30} style={{marginRight: 15,}}/> 
             </View>
              
        </View>

        <View style={styles.container}>
        <Text style={styles.head2}>The{"\n"}Demonstrative</Text>
        <Text style={styles.intro}>
       {w2}
        </Text>
        <Text style={styles.keyword}>Examples:</Text>
              <Text style={styles.keyword}>{w11}    <Text style={styles.keyword2}> these oranges</Text></Text>
              <Text style={styles.keyword}>{w12}     <Text style={styles.keyword2}>these thighs</Text></Text>
              <Text style={styles.keyword}>{w13}     <Text style={styles.keyword2}> this water</Text></Text>
              <View style={styles.move}>
             <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={30} style={{marginRight: 15,}}/> 
             </View>
        ...
        <View style={styles.container}>
        <Text style={styles.head}>The Presentative</Text>
        <Text style={styles.intro}>{w3}</Text>
        <Text style={styles.keyword}>Examples:</Text>
              <Text style={styles.keyword}>{w14}    <Text style={styles.keyword2}> the house is here</Text></Text>
              <Text style={styles.keyword}>{w15}     <Text style={styles.keyword2}>that is the house</Text></Text>
              <Text style={styles.keyword}>{w16}     <Text style={styles.keyword2}> the houses are here</Text></Text>
              <View style={styles.move}>
             <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={30} style={{marginRight: 15,}}/> 
             </View>
        </View>
        ...
        <View style={styles.container}>
        <Text style={styles.head}>The Relative construction</Text>
        <Text style={styles.intro}>{w4}</Text>
        <Text style={styles.keyword}>Examples:</Text>
              <Text style={styles.keyword}>{w17}</Text>
              <Text style={styles.keyword2}>{w18}</Text>
              <View style={styles.move}>
             <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={30} style={{marginRight: 15,}}/> 
             </View>
        </View>
        ...
        <View style={styles.container}>
        <Text style={styles.head}>The concord consonant</Text>
        <Text style={styles.intro}>
          {w5}
        </Text> 
        <View style={styles.move}>
             <MaterialCommunityIcons name="gesture-swipe-right" color='#5ff232' size={30} style={{marginRight: 15,}}/> 
             </View>
        </View>
