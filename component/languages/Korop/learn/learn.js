...
function createTwoButtonAlert(){
 ...
 function reference(){
   Alert.alert(
     "Reference",
     "A Phonological and Grammatical Sketch of DuRop\n\nBianca Kastelein",
     "",
     "",
     [
       {
           ...
           <Text style={styles.title}>LEARN</Text>
            ...
            <View style={styles.content}>
               <Button style={{width: 150, bottom: 45}}
                      ...
                      mode="outlined"
                      >
                        About<Text style={{color: "blue"}}> KOROP</Text>             
                     </Button>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1}}>
                     ...
                     <FastImage source={{uri:'https://cdn.dribbble.com/users/2536766/screenshots/6290371/com-gif2.gif'}} style={{height: 250, width: 350, left: 5, top: 15}}/>
                     </View>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                        <View style={{width: 310, height: 200, alignItems: 'center'}}>
                     <FastImage source={{uri:'https://img.freepik.com/free-vector/hipster-people-talking-using-computers-co-working_74855-5267.jpg?size=626&ext=jpg'}} style={{height: 270, width: 350, left: 10}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
            ...
            <Card style={{borderWidth: 1, borderColor: 'grey', borderRadius: 3, elevation: 1, marginTop: 20}}>
                        <View style={{width: 310, height: 200, alignItems: 'center'}}>
                     <FastImage source={{uri:'https://i.pinimg.com/originals/14/21/78/14217870a78977f74b3c6167063bfc6f.gif'}} style={{height: 300, width: 350}}/>
                     </View>
                     <View style={{flexDirection: 'row', marginTop: 100}}>                     
                     <View style={styles.option1}>
