    ...
    return (
       ...
       <View style={styles.content}>
                        <View style={{marginTop: 150}}></View>
                            <Text style={styles.head}>Tone class and type</Text>
                            <View style={{ width: "100%"}}>
                        <DataTable>
      <DataTable.Header>
        <DataTable.Title>Tone{"\n"}class</DataTable.Title>
        <DataTable.Title >Type 1</DataTable.Title>
        <DataTable.Title >Type 2</DataTable.Title>
      </DataTable.Header>
      ...
      <DataTable.Row>
        ...
        <DataTable.Cell >{w10}</DataTable.Cell>
      </DataTable.Row>

      <DataTable.Row>
        <DataTable.Cell>{w11}</DataTable.Cell>
        <DataTable.Cell >{w12}</DataTable.Cell>
      ...
      />
                        ...
                        <View style={styles.container}>
        <Text style={styles.head}>ASPECT</Text>
              <Text style={styles.intro}>
                {w14}
              </Text>
              <Text style={styles.keyword}>Example:{"\n"}</Text>
              <Text style={styles.keyword}>{w15}{"\n"}</Text>
              <Text style={styles.keyword}>{w16}{"\n"}</Text>
        ...
        <View style={styles.container}>
        <Text style={styles.head}>Future Tense</Text>
        <View style={{marginTop: 100}} />
              <Text style={styles.intro}>
                {w19}
              </Text>
              <Text style={styles.keyword}>Example:{"\n"}</Text>
              <Text style={styles.keyword}>{w20}{"\n"}</Text>
              <Text style={styles.keyword}>{w21}</Text>
              <Text style={styles.keyword}>{w22}{"\n"}</Text>
              <Text style={styles.keyword}>{w23}{"\n"}</Text>
              <View style={styles.move}>
                            <MaterialCommunityIcons name="gesture-swipe-horizontal" color='grey' size={30} style={{marginBottom: 10, marginRight: 15,}}/> 
              </View>
        </View>       
         ...
         <View style={styles.container}>
        <Text style={styles.head}>NEGATION</Text>
        <View style={{marginTop: 100}} />
              <Text style={styles.intro}>
                {w24}
              </Text>
              <Text style={styles.keyword}>Example:{"\n"}</Text>
              <Text style={styles.keyword}>{w25}{"\n"}</Text>
