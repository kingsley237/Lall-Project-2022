   ...
   langInfo.child('info').on('value', snapshot => {  
    ...
    return (
        <ScrollView contentContainerStyle={{backgroundColor: 'white', height: 1550}}>
                <FastImage source={{uri: 'https://live.staticflickr.com/4013/4417225128_d5ab6f1ce7_z.jpg'}} style={{height: 380, width: Dimensions.get("window").width, bottom: 50, marginBottom: 70}}/>
                        <View style={{bottom: 60}}>
                        <Text style={styles.head}>Korop</Text>
                        <Divider/>
                        </View>
      ...
      <DataTable.Row>
        <DataTable.Cell>DuRop</DataTable.Cell>
        <DataTable.Cell >Language</DataTable.Cell>
        <DataTable.Cell numeric>See above.</DataTable.Cell>
      </DataTable.Row>

      <DataTable.Row>
        <DataTable.Cell>Villages</DataTable.Cell>
        <DataTable.Cell>4</DataTable.Cell>
        <DataTable.Cell numeric>In CMR currently.</DataTable.Cell>
      </DataTable.Row>
