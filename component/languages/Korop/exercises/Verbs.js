...
const data = [
    {
      label: 'Using the suffix ŋ́-'
     },
     {
      label: 'Verb stem + tone class'
     },
     {
        label: 'Using the prefix ù-'
     },
     {
...
const data5 = [
                    {
                      label: 'He will be refusing'
                     },
                     {
                      label: 'They shall be standing'
                     },
                     {
                        label: 'We will send you'
                     },
                     {
                        label: 'None of the above'
                       }
