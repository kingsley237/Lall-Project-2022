...
const data4 = [
                {
                 ...
                 {
                  label: 'ú-nɔ́n ú-ŋ́ó'
                 },
                 {
                    label: 'ú-nɔ́n ù-mí'
                 },
                 {
                    label: 'All the above'
                   }
...
function SalutationEx() {   
    ...
    var db =  database().ref(ref+'/PronounsExercise');
...
db.child('w1').on('value', snapshot => {
  ...
  return () => database().ref(ref+'/PronounsExercise').off('child_added', onChildDelete);
  }, []);      
  ...
  if(w1 === "" || w2 === "" || w3 === "" || w4 === "" || w5 === ""){
    ...
    function tip(){
        Alert.alert(
          "Tip",
          "Which is \"ɲ́cɛ̀nì\" so it translates to \"ɲ́cɛ̀nì ŋ̀wɛ̀d\"",
          [
            {
              text: "Cancel",
              style: "cancel"
            ...
            color="#330000">
                ...
                <View style={styles.container}>
                        ...
                        <Text style={styles.intro}>
                            <Text style={styles.bold}>Note: </Text>Refer to the Pronoun section and answer the questions posed.</Text>
                                <View style={styles.content}>
                                            <Text style={styles.question}>{w1}</Text>
                                                    <View style={styles.radio}>
                                                        ...
                                                        duration={300}
                                                        activeColor={'#330000'}
                                                        boxActiveBgColor={'rgb(203,150,150)'}
                                                            data={data}
