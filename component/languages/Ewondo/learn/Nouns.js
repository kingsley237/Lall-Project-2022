...
if(intro === "" || w1 === "" || w2 === "" || w3 === "" || w4 === "" || w5 === "" || w6 === "" || w7 === ""|| w8 === "" || w9 === "" || w10 === "" || w11 === "" || w12 === "" || w13 === "" || w14 === "" || w15 === "" || w16 === "" || w17 === "" || w18 === "" || w19 === "" || w20 === "" || w21 === "" || w22 === "" || w23 === "" || w24 === "" || w25 === "" || w26 === "" || w27 === "" || w28 === "" || w29 === "" || w30 === "" || w31 === "" || w32 === "" || w33 === "" || w34 === "" || w35 === "" || w36 === "" || w37 === "" || w38 === "" || w39 === "" || w40 === "" ||w41 === ""){
  ...
  showBubbles={false}>
       <View style={styles.container}>
        <Text style={styles.head}>Noun Classes</Text>
        ...
        <View style={styles.container}>
        <Text style={styles.head2}>Classes 1 & 2</Text>
              <Text style={styles.intro}>
                {w1}
                </Text>
              <Text style={styles.keyword}>Example:</Text>
              <Text style={styles.keyword}>{w2}    <Text style={styles.keyword}> m̀bələ́</Text>    evil person | owner</Text>
              <Text style={styles.keyword}>{w3}     <Text style={styles.keyword}> ǹdiŋan     lover | loved one</Text></Text>
              <Text style={styles.keyword}>{w4}     <Text style={styles.keyword}> ŋ̀kɛɛ</Text>      builder | assistant</Text>
              <View style={styles.move}>
        ...
        <View style={styles.container}>
        <Text style={styles.head2}>Classes 3 & 4</Text>
              <Text style={styles.intro}>
              {w5}
              </Text>
              <Text style={styles.keyword}>Example:</Text>
              <Text style={styles.keyword}>{w6}    <Text style={styles.keyword}> stupid person</Text></Text>
              <Text style={styles.keyword}>{w7}     <Text style={styles.keyword}> thief</Text></Text>
              <Text style={styles.keyword}>{w8}     <Text style={styles.keyword}> chief    miŋkúkúma | chiefs</Text></Text>
              <View style={styles.move}>
                            <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={30} style={{marginBottom: 10, marginRight: 15,}}/> 
                            </View>
        </View>
        ...
        <View style={styles.container}>
        <Text style={styles.head2}>Classes 5 & 6</Text>
              <Text style={styles.intro}>
              {w9}
              </Text>
              <Text style={styles.keyword}>Example:</Text>
              <Text style={styles.keyword}>{w10}    <Text style={styles.keyword}>   eye</Text></Text>
              <Text style={styles.keyword}>{w11}     <Text style={styles.keyword}> wing</Text></Text>
              <Text style={styles.keyword}>{w12}     <Text style={styles.keyword}>  foot</Text></Text>
              <View style={styles.move}>
                            <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={30} style={{marginBottom: 10, marginRight: 15,}}/> 
                            </View>
        </View>
        ...
        <View style={styles.container}>
        <Text style={styles.head2}>Classes 7 & 8</Text>
              <Text style={styles.intro}>
                {w13}
                </Text>
              <Text style={styles.keyword}>Example:</Text>
              <Text style={styles.keyword}>{w14}    <Text style={styles.keyword}>  love</Text></Text>
              <Text style={styles.keyword}>{w15}     <Text style={styles.keyword}>   abstention</Text></Text>
              <Text style={styles.keyword}>{w16}     <Text style={styles.keyword}> curse</Text></Text>
              <View style={styles.move}>
                            <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={30} style={{marginBottom: 10, marginRight: 15,}}/> 
                            </View>
        </View>
        ...
        <View style={styles.container}>
        <Text style={styles.head2}>Classes 9 & 10</Text>
              <Text style={styles.intro}>
              {w17}
              </Text>
              <Text style={styles.keyword}>Example:</Text>
              <Text style={styles.keyword}>{w18}    <Text style={styles.keyword}>  grandparent</Text></Text>
              <Text style={styles.keyword}>{w19}     <Text style={styles.keyword}>   co-wife</Text></Text>
              <Text style={styles.keyword}>{w20}     <Text style={styles.keyword}> daughter</Text></Text>
              <View style={styles.move}>
                            <MaterialCommunityIcons name="gesture-swipe-horizontal" color='#5ff232' size={30} style={{marginBottom: 10, marginRight: 15,}}/> 
                            </View>
        </View>
        ...
        <View style={styles.container}>
        <Text style={styles.head2}>Classes 16 & 19</Text>
              <Text style={styles.intro}>
                {w21}
                </Text>
        </View>
        ...
        <View style={styles.container}>
        <Text style={styles.head2}>Noun formation</Text>
        <Text style={styles.intro}>{w22}</Text>
              <DataTable>
      <DataTable.Header>
        <DataTable.Title>Word</DataTable.Title>
        <DataTable.Title numeric>Meaning</DataTable.Title>
        <DataTable.Title numeric>Duplication</DataTable.Title>
        <DataTable.Title numeric>Meaning</DataTable.Title>
      </DataTable.Header>

      <DataTable.Row>
        <DataTable.Cell>zam</DataTable.Cell>
        <DataTable.Cell numeric>{w23}</DataTable.Cell>
        <DataTable.Cell numeric>ǹzə́zām</DataTable.Cell>
        <DataTable.Cell numeric>{w23}</DataTable.Cell>
      </DataTable.Row>

      <DataTable.Row>
        <DataTable.Cell>biaŋ</DataTable.Cell>
        <DataTable.Cell numeric>{w24}</DataTable.Cell>
        <DataTable.Cell numeric>m̀bebíáŋ</DataTable.Cell>
        <DataTable.Cell numeric>{w25}</DataTable.Cell>
      </DataTable.Row>

      <DataTable.Row>
        <DataTable.Cell>asum</DataTable.Cell>
        <DataTable.Cell numeric>{w26}</DataTable.Cell>
        <DataTable.Cell numeric>ǹsusúm</DataTable.Cell>
      ...
      />
        ...
        <Text style={styles.intro}>{w28}</Text>
              <DataTable>
      <DataTable.Header>
        <DataTable.Title></DataTable.Title>
        <DataTable.Title numeric>Singular</DataTable.Title>
        <DataTable.Title numeric>Plural</DataTable.Title>
        <DataTable.Title numeric></DataTable.Title>
      </DataTable.Header>

      <DataTable.Row>
        <DataTable.Cell>1st person</DataTable.Cell>
        <DataTable.Cell numeric>{w29}</DataTable.Cell>
        <DataTable.Cell numeric>{w30}</DataTable.Cell>
        <DataTable.Cell numeric>we | us</DataTable.Cell>
      </DataTable.Row>

      <DataTable.Row>
        <DataTable.Cell>2nd person</DataTable.Cell>
        <DataTable.Cell numeric>{w31}</DataTable.Cell>
        <DataTable.Cell numeric>{w32}</DataTable.Cell>
        <DataTable.Cell numeric>you</DataTable.Cell>
      </DataTable.Row>
      ...
      />
        ...
        <View style={styles.container}>
        <Text style={styles.head}>Possessive pronoun</Text>
