  ...
  setw41("N/A");
    ...
    return (
        ...
        <Text style={styles.head}>VERBS</Text>
              ...
              <Text style={styles.keyword}>Basic types in Ewondo:{"\n"}</Text>
       ...
       <View style={styles.content}>
                            <Text style={styles.head2}>Locative-stative verbs</Text>
                            <Text style={styles.intro}>{w3}</Text>
                            <View style={{marginTop: 20}}></View>
                            <DataTable>
      <DataTable.Header>
        <DataTable.Title>Singular</DataTable.Title>
      ...
      />
                        ...
                        <View style={styles.content}>
                            <Text style={styles.head2}>Action verbs</Text>
                            <Text style={styles.intro}>{w8}</Text>
                        ...
                        <View style={{marginTop: 150}}></View>
                            <Text style={styles.head2}>Some additional action verbs</Text>

                            <DataTable>
                            <DataTable.Header>
                              <DataTable.Title>{w13}</DataTable.Title>
                              <DataTable.Title numeric>{w14}</DataTable.Title>
                            </DataTable.Header>

                            <DataTable.Row>
                              <DataTable.Cell>{w15}</DataTable.Cell>
                              <DataTable.Cell numeric>I am doing/making</DataTable.Cell>
                            </DataTable.Row>

                            <DataTable.Row>
                              <DataTable.Cell>{w16}</DataTable.Cell>
                              <DataTable.Cell numeric>I am setting on fire</DataTable.Cell>
                            </DataTable.Row>
                            <DataTable.Row>
                              <DataTable.Cell>{w17}</DataTable.Cell>
                              <DataTable.Cell numeric>I am catching/holding</DataTable.Cell>
                            </DataTable.Row>
                            <DataTable.Row>
                              <DataTable.Cell>{w18}</DataTable.Cell>
                              <DataTable.Cell numeric>I am buying</DataTable.Cell>
                            </DataTable.Row>
                            <DataTable.Row>
                              <DataTable.Cell>{w19}</DataTable.Cell>
                              <DataTable.Cell numeric>I am happy</DataTable.Cell>
                            </DataTable.Row>
                            <DataTable.Row>
                              <DataTable.Cell>{w20}</DataTable.Cell>
                              <DataTable.Cell numeric>I am dying</DataTable.Cell>
                            </DataTable.Row>
                            <DataTable.Row>
                              <DataTable.Cell>{w21}</DataTable.Cell>
                              <DataTable.Cell numeric>Ifell/hear/perceive</DataTable.Cell>
                            </DataTable.Row>
                            <DataTable.Row>
                              <DataTable.Cell>{w22}</DataTable.Cell>
                              <DataTable.Cell numeric>I am leaving behind</DataTable.Cell>
                            </DataTable.Row>
                        ...
                        <View style={styles.content}>
                            <Text style={styles.head2}>Negatives of verbs</Text>
                        <Text style={styles.intro}>
                          {w23}
                        </Text>
      ...
      <DataTable.Row>
        <DataTable.Cell>1st. pers.</DataTable.Cell>
      ...
      <DataTable.Row>
        <DataTable.Cell>2nd. pers.</DataTable.Cell>
        <DataTable.Cell numeric></DataTable.Cell>
        <DataTable.Cell numeric></DataTable.Cell>
        <DataTable.Cell numeric></DataTable.Cell>
...
<DataTable.Row>
  <DataTable.Cell>CL. 1</DataTable.Cell>
  <DataTable.Cell numeric></DataTable.Cell>
...
<DataTable.Row>
        <DataTable.Cell>Cl. 2</DataTable.Cell>
        <DataTable.Cell numeric></DataTable.Cell>
        <DataTable.Cell numeric></DataTable.Cell>
        <DataTable.Cell numeric></DataTable.Cell>
    ...
    <View style={styles.move}>
                        ...
                        <View style={styles.container}>
        <Text style={styles.head}>ADVERBS</Text>
              <Text style={styles.intro}>
                {w28}
                </Text>
              <Text style={styles.keyword}>Basic types in Ewondo:{"\n"}</Text>
        ...
        <View style={styles.content}>
                            <Text style={styles.head2}>Locative adverbs</Text>
                        <Text style={styles.intro}>
                         {w31}
                        </Text>
                        <View style={{marginTop: 50}}></View>
              ...
              <DataTable>
      <DataTable.Header>
        <DataTable.Title>{w32}</DataTable.Title>
        <DataTable.Title numeric>{w33}</DataTable.Title>
      </DataTable.Header>

      <DataTable.Row>
        <DataTable.Cell>{w34}</DataTable.Cell>
        <DataTable.Cell numeric>here, by/near speaker</DataTable.Cell>
      </DataTable.Row>

      <DataTable.Row>
        <DataTable.Cell>{w35}</DataTable.Cell>
        <DataTable.Cell numeric>there, by/near hearer</DataTable.Cell>
      </DataTable.Row>

      <DataTable.Row>
        <DataTable.Cell>{w36}</DataTable.Cell>
        <DataTable.Cell numeric>there, away from both speaker and hearer</DataTable.Cell>
      </DataTable.Row>

      <DataTable.Row>
        <DataTable.Cell>{w37}</DataTable.Cell>
        <DataTable.Cell numeric>yonder, away from both speaker and hearer</DataTable.Cell>
      </DataTable.Row>
