...
const data = [
    {
      label: 'Seperating stems from words'
     },
     {
      label: 'Adding prammatical tones'
     },
     {
        label: 'Partial reduplication of the stem'
     },
     {
...
function salutationEx() {     
    ...
    var db =  database().ref(ref+'/FormationExercise');
...
db.child('w1').on('value', snapshot => {
  ...
  return () => database().ref(ref+'/FormationExercise').off('child_added', onChildDelete);
  }, []); 
  if(w1 === "" || w2 === "" || w3 === "" || w4 === "" || w5 === ""){
            ...
            color="#003366">
                ...
                <View style={styles.container}>
                        ...
                        <Text style={styles.intro}>
                            <Text style={styles.bold}>Note: </Text>Refer to the Word formation section and answer the questions posed.</Text>
                                <View style={styles.content}>
                                            <Text style={styles.question}>{w1}</Text>
                                                    <View style={styles.radio}>
                                                        ...
                                                        duration={300}
                                                        activeColor={'#003366'}
                                                        boxActiveBgColor={'rgb(66,160,189)'}
                                                            data={data}
