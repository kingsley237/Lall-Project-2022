...
const data = [
    {
      label: 'State or condition'
     },
     {
      label: 'Location and state'
     },
     {
...
const data5 = [
                    {
                     ...
                     {
                        label: 'I am setting on fire'
                     },
                     {
                        label: 'I fell or percieve'
                       }
     ];
  ...
  if(w1 === "" || w2 === "" || w3 === "" || w4 === "" || w5 === ""){
    ...
    function checkAnswer(value1) {
        if(value1 != ans){
            ...
            Alert.alert(
                "Tip",
                "They refer to the present or any time in the past",
                [
                  {
                    text: "Cancel",
